...
export const Navigation = () => {
  ...
  return (
    <nav className="flex justify-center pb-5 md:py-0 md:flex-col md:justify-start items-center gap-y-5 bg-white border border-gray-200 px-2 lg:px-6 dark:bg-gray-800 shadow">
